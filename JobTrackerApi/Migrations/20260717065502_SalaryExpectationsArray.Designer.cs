...
namespace JobTrackerApi.Migrations
{
    ...
    [Migration("20260717065502_SalaryExpectationsArray")]
    partial class SalaryExpectationsArray
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobTrackerApi.Models.UserProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("JobTrackerApi.Models.UserProfile", b =>
                {
                    b.HasOne("JobTrackerApi.Models.ApplicationUser", "User")
                        .WithOne()
                        .HasForeignKey("JobTrackerApi.Models.UserProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsMany("JobTrackerApi.Models.EducationEntry", "Education", b1 =>
                        {
                    ...
                    b.OwnsMany("JobTrackerApi.Models.PreferredLocationEntry", "PreferredLocations", b1 =>
                        {
                            ...
                            b1.PrimitiveCollection<string>("Areas")
                                .IsRequired()
                                .HasMaxLength(10);
                    ...
                    b.OwnsMany("JobTrackerApi.Models.WorkHistoryEntry", "WorkHistory", b1 =>
                        {
                            b1.Property<int>("UserProfileId");
                    ...
                    b.OwnsMany("JobTrackerApi.Models.WorkingRightEntry", "WorkingRights", b1 =>
                        {
                            b1.Property<int>("UserProfileId");
