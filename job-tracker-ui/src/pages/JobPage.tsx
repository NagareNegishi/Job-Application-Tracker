...
function JobPage() {
  ...
  return (
    <div className="h-screen bg-muted flex flex-col overflow-hidden">
      <NavBar />
      <div className="max-w-7xl mx-auto w-full px-4 py-2 flex justify-end">
        <IconToggle options={VIEW_OPTIONS} value={viewMode} onChange={setViewMode} />
      </div>

      <div className={`max-w-7xl ${viewMode === 'kanban' ? 'px-1 sm:px-2' : 'px-2 sm:px-4'} mx-auto w-full pb-1 flex-1 flex flex-col min-h-0 min-w-0`}>
