...
function JobPage() {
  ...
  return (
    <div className="h-screen bg-muted flex flex-col overflow-hidden">
      <NavBar />
      {/* View toggle */}
      <div className="w-full flex justify-end px-6 pt-8 pb-4">
      ...
      <div className={`${viewMode === 'kanban' ? 'max-w-7xl px-2' : 'max-w-5xl px-6'} mx-auto pb-8 flex-1 flex flex-col min-h-0`}>
