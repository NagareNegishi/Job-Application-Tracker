...
| Job analysis | `UserProfile` table + 5 AI analysis endpoints + detail page UI | Profile, Conditions expansion, backend, and Step 9 (analysis UI, all 5 buttons wired) done. Remaining: Step 10 (ad-hoc entry point), C8 (frontend `concern` display). See `docs/plans/job-analysis.md`. |
