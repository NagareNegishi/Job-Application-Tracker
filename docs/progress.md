...
| Job analysis | `UserProfile` table + 5 AI analysis endpoints + detail page UI | Planning — polishing design decisions in `docs/plans/job-analysis.md` (Open Decisions: D1–D6 settled; resume at D7) |
