...
| Job analysis | `UserProfile` table + 5 AI analysis endpoints + detail page UI | Steps 1–3 done. Next: **Step 4** — `/profile` frontend page (in progress: types, service, hook, page skeleton done; tag sections, working rights, work history, education, route + nav link remaining). See `docs/plans/job-analysis.md`. |
